...
function renderDetail(p) {
  ...
  document.getElementById('detailMainImage').src = p.image;
...
function wireAddToCart() {
  ...
  function addToCart() {
    ...
    if (existing) {
      ...
      cart.push({ id: currentProduct.id, name: currentProduct.name, price: currentProduct.price, image: currentProduct.image, qty: currentQty });
    }
