/* ============================================================
   auth.js
   Đăng ký / Đăng nhập / Quên mật khẩu / Hồ sơ người dùng
   - Validate bằng Regex (email, độ dài mật khẩu)
   - Tài khoản được lưu vào LocalStorage (key: "accounts")
   - Người đang đăng nhập lưu ở LocalStorage (key: "currentUser")
   ============================================================ */
